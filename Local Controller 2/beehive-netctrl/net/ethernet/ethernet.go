...
const (
	...
	ETH_T_BPDU EtherType = 36
	ETH_ARP    EtherType = 2054
	ETH_IPV4   EtherType = 2048
)
...
//nuevo
func (this *Ethernet) SetTrailer() {
	offset := this.TrailerOffset()

	//binary.BigEndian.PutUint16(this.Buf[offset:], 0)
	for i := 0; i < 8; i++ {
		this.Buf[offset] = byte(1)
		offset++
	}
}

func (this Ethernet) TrailerOffset() int {
	offset := 52
	return offset
}

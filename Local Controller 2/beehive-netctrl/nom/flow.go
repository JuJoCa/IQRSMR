...
func (a ActionFlood) Equals(thata Action) bool {
	...
	//fmt.Println("thataf: ", thataf, " a.InPort: ", a.InPort, " thataf.InPort: ", thataf.InPort)
	if !ok {
		return false
	}
...
func (a ActionSendToController) String() string {
	return fmt.Sprintf("SendToMaster")
}

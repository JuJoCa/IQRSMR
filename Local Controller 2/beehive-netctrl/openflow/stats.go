...
func (d *of13Driver) handlePortStatsReply(reply of13.PortStatsReply,
	c *ofConn) error {
	//fmt.Println("-------- Entra a PortStats reply--------")
	//fmt.Println("statsPort: ", reply.Buf[:40])
	...
	//fmt.Println("statportpk: ", nomReply.Node, "$$", nomReply.Port, " --> ", nomReply.Stats[0].TxPackets, " - ", nomReply.Stats[0].RxPackets)
	c.ctx.Emit(nomReply)
